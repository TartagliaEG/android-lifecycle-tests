...
public class RetainedFlowActivity extends LoggerActivity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    findViewById(R.id.btn_dialog).setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        startActivity(new Intent(RetainedFlowActivity.this, DialogActivity.class));
      }
    });

    if (fragment == null) {
      fragment = new RetainedFlowFragment();
      getFragmentManager()
        .beginTransaction()
        .add(fragment, "TAG")
        .commit();
  ...
  @Override public void onAttachFragment(Fragment fragment) {
    ...
    v.setText("Invisible retained fragment: " + getFragmentManager().findFragmentByTag("TAG").getClass().getSimpleName());
  }
}
